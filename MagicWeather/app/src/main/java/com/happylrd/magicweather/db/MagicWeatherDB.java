package com.happylrd.magicweather.db;
...
public class MagicWeatherDB {

    public static final String DB_NAME = "magic_weather";

    public static final int VERSION = 1;

    private static MagicWeatherDB magicWeatherDB;

    private SQLiteDatabase db;

    private MagicWeatherDB(Context context) {
        MagicWeatherOpenHelper dbHelper =
                new MagicWeatherOpenHelper(context, DB_NAME, null, VERSION);
        db = dbHelper.getWritableDatabase();
    }

    public synchronized static MagicWeatherDB getInstance(Context context) {
        if (magicWeatherDB == null) {
            magicWeatherDB = new MagicWeatherDB(context);
        }
        return magicWeatherDB;
    }
